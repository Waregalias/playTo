...
const weapons: ItemSeed[] = [
  // Tier 1 — starter kit
  {
    ...
    stackable: false,
    maxDurability: 100,
    stats: { power: 6, damageKind: 'physical', classRestriction: 'blade' },
  },
  {
    id: 'weapon.arcanist.t1',
    kind: 'weapon',
    rarity: 'common',
    stackable: false,
    maxDurability: 100,
    stats: { power: 6, damageKind: 'arcane', classRestriction: 'arcanist' },
  },
  {
    id: 'weapon.scout.t1',
    kind: 'weapon',
    ...
    stackable: false,
    maxDurability: 100,
    stats: { power: 6, damageKind: 'physical', classRestriction: 'scout' },
  },
  {
    id: 'weapon.cantor.t1',
    kind: 'weapon',
    ...
    stackable: false,
    maxDurability: 100,
    stats: { power: 6, damageKind: 'arcane', classRestriction: 'cantor' },
  },
  // Tier 2 — Q4 reward
  {
    id: 'weapon.blade.t2',
    ...
    stackable: false,
    maxDurability: 100,
    stats: { power: 10, damageKind: 'physical', classRestriction: 'blade' },
  },
  {
    id: 'weapon.arcanist.t2',
    kind: 'weapon',
    rarity: 'rare',
    stackable: false,
    maxDurability: 100,
    stats: { power: 10, damageKind: 'arcane', classRestriction: 'arcanist' },
  },
  {
    id: 'weapon.scout.t2',
    kind: 'weapon',
    ...
    stackable: false,
    maxDurability: 100,
    stats: { power: 10, damageKind: 'physical', classRestriction: 'scout' },
  },
  {
    id: 'weapon.cantor.t2',
    kind: 'weapon',
    ...
    stackable: false,
    maxDurability: 100,
    stats: { power: 10, damageKind: 'arcane', classRestriction: 'cantor' },
  },
];
